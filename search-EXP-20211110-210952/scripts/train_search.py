...
def main():
  ...
  for epoch in range(args.epochs):
    ...
    # training
    train_acc, train_obj = train(train_queue, valid_queue, model, architect, criterion, optimizer, lr, start, epoch)
    scheduler.step()
...
def train(train_queue, valid_queue, model, architect, criterion, optimizer, lr, start, epoch):
